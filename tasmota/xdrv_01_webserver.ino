...
const char HTTP_END[] PROGMEM =
  "<div style='text-align:right;font-size:11px;'><hr/><a href='https://bit.ly/tasmota' target='_blank' style='color:#aaa;'>Tasmota %s " D_BY " Theo Arends</a> <a href='" D_MODIFIED_WEBLINK "' target='_blank' style='color:#aaa;'>" D_MODIFIED " " D_BY " " D_MODIFY_AUTHOR "</a></div>"
  "</div>"
  "</body>"
  "</html>";
