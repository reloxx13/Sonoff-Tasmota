set version=6.5.0.12-mod-1.45.11-nils
...
copy ..\.pioenvs\sonoff-KO\firmware.bin %version%\KO-firmware-%version%.bin
...
copy ..\.pioenvs\sonoff-SK\firmware.bin %version%\SK-firmware-%version%.bin
copy ..\.pioenvs\sonoff-SE\firmware.bin %version%\SE-firmware-%version%.bin
...
copy ..\.pioenvs\sonoff-basic\firmware.bin %version%\BASIC-firmware-%version%.bin
...
copy ..\.pioenvs\sonoff-display\firmware.bin %version%\DISPLAY-firmware-%version%.bin
